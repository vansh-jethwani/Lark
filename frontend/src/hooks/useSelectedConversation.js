  ...
  const mappedMessages = (Array.isArray(messages) ? messages : []).map((message) => {
    const replyTo = message.replyTo
      ? {
          ...
          imageThumbnailUrl: message.replyTo.imageThumbnail,
          imageOriginalUrl: message.replyTo.imageOriginal,
          videoUrl: message.replyTo.video,
          videoThumbnailUrl: message.replyTo.videoThumbnail,
    ...
    return {
      ...
      imageThumbnailUrl: message.imageThumbnail,
      imageOriginalUrl: message.imageOriginal,
      videoUrl: message.video,
      videoThumbnailUrl: message.videoThumbnail,
